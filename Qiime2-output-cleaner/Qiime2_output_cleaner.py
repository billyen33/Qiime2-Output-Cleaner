...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.featuretable_entry.insert(0, 'Ex. C:\Research/feature-table.tsv')
        ...
        self.taxatable_entry.insert(0, 'Ex. C:\Research/taxonomy.tsv')
        ...
        self.explain2.place(x=81,y=490)
